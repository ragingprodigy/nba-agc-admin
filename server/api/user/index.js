...
router.get('/getDistinctGroups', sessionSec, controller.getDistinctGroups);
...
router.get('/allUnprintedUsersForNameTags', sessionSec, controller.allUnprintedUsersForNameTags);
