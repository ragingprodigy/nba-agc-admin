/**
 * Created by radiumrasheed on 8/11/16.
 *
 * Database Model For Offline Registration
 */
...
var OfflineRegSchema = new Schema({
...
OfflineRegSchema.statics.pRef = pRef;

OfflineRegSchema.pre('save', function(next){
    this.lastModified = new Date();
    next();
});

module.exports = mongoose.model('OfflineReg', OfflineRegSchema);
